...
class NotificationServices {
  ...
  void initLocalNotifications(
    ...
    // const AndroidInitializationSettings('no_bg_logo');
  ...
  void firebaseInit(BuildContext context) {
    FirebaseMessaging.onMessage.listen((message) {
      ...
      if (kDebugMode) {
        ...
        print('data mess:${message.toString()}');
      }
  ...
  Future<void> handleMessage(
      BuildContext context, RemoteMessage message) async {
    print("from handle message driver ${message.data}");
    ...
    if (message.data['click_action'] == 'message') {
      await customersRef
          ...
          .then((value) async {
        if (value.data() != null) {
          CustomerModel customer = CustomerModel.fromMap(value.data()!);
          Get.to(() => ChatScreen(receiverUser: customer));
        }
      });
    }
   else if (message.data['click_action'] == 'job') {
      await jobsRef
          .doc(message.data['jobid'])
          .get()
          .then((value) async {
        if (value.data() != null) {
          JobModel jobdata = JobModel.fromMap(value.data()!);
