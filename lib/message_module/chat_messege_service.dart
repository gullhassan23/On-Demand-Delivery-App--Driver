...
class ChatMessageService extends BaseService {
  ...
  ChatMessageService() {
    ...
    userRef = fireStore.collection("Customers");
  }

  Query chatMessagesWithPagination(
      {String? senderId, required String receiverUserId}) {
  ...
  Stream<CustomerModel> getUserDetailsById({String? id}) {
    return userRef!
  ...
  Stream<int> getUnReadCount(
    ...
    return ref!
        ...
        .map(
          (event){
            print("get unread call${event.docs.length}");
  ...
  Query fetchChatListQuery({String? userId}) {
    print("current usser ${userId}");
    return fireStore.collection("Drivers").doc(userId).collection("contact");
  }
}
