...
class ChatWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [SizedBox(height: screenSize.height*0.05,),
        Row(
  ...
  onPressed: () {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Massages()), // Replace SecondPage with the destination page you want to navigate to
    );
  },
),
  ...
  child: TextFormField(
    decoration: InputDecoration(
      contentPadding: EdgeInsets.symmetric(vertical: 0), // Removes vertical padding
      hintText: 'Type a message...',
      prefixIcon: Icon(Icons.attach_file, color: Colors.grey),
      suffixIcon: Icon(Icons.sentiment_satisfied, color: Colors.grey),
...
List<Message> messages = [
  Message('Hai Raizal , I,m on the way to your home, Please wait a moment.Thanks,', false),
  Message('ThankYou! Ill be waiting for that', true),
  Message('Hai riazal, I , m on the wat to your home , please wait for a moment ', false),
